...
from rolepermissions.decorators import has_role_decorator, has_roles_decorator, has_permission_decorator
...
class HasRolesDetailView(DetailView):

    @method_decorator(has_roles_decorator(['dec_role1', DecRole2]))
    def dispatch(self, request, *args, **kwargs):
        return super(HasRolesDetailView, self).dispatch(request, *args, **kwargs)
